...
namespace Z2data.Core.Configuration
{
    /// <summary>
    /// Represents a Z2dataConfig
    /// </summary>
    public partial class Z2dataConfig : IConfigurationSectionHandler
    {
        /// <summary>
        ...
        public object Create(object parent, object configContext, XmlNode section)
        {
            ...
            var supportPreviousZ2dataVersionsNode = section.SelectSingleNode("SupportPreviousZ2dataVersions");
            config.SupportPreviousZ2dataVersions = GetBool(supportPreviousZ2dataVersionsNode, "Enabled");
        ...
        /// <summary>
        /// Indicates whether we should support previous Z2data versions (it can slightly improve performance)
        /// </summary>
        public bool SupportPreviousZ2dataVersions { get; private set; }
        ...
        /// <summary>
        /// A list of plugins ignored during Z2data installation
        /// </summary>

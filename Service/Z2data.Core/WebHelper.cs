    ...
    public partial class WebHelper : IWebHelper
    {
        ...
        public virtual void RestartAppDomain(bool makeRedirect = false, string redirectUrl = "")
        {
            ...
            else
            {
                ...
                if (!success)
                {
                    throw new Z2dataException("Z2data needs to be restarted due to a configuration change, but was unable to do so." + Environment.NewLine +
        ...
        public virtual bool IsPostBeingDone
        {
            get
            {
                if (_httpContext.Items["Z2data.IsPOSTBeingDone"] == null)
                    return false;
                return Convert.ToBoolean(_httpContext.Items["Z2data.IsPOSTBeingDone"]);
            }
            set
            {
                _httpContext.Items["Z2data.IsPOSTBeingDone"] = value;
            }
        }

        public virtual bool byteArrayToFile(byte[] byteArray, string Path)
        {
